...
_VISION_MODEL_CONFIGS = {
    ...
    "chameleon_7b": ("offline_inference_vision_language.py", ["--max-tokens 256", "-tp 1"], None, ["VLLM_ASSETS_CACHE=../vllm/"]),
    "fuyu_8b": ("offline_inference_vision_language.py", ["--max-tokens 256", "-tp 1"], None, ["VLLM_ASSETS_CACHE=../vllm/"]),
    "idefics3": ("offline_inference_vision_language.py", ["--model-type idefics3"], None, []),
    "h2vol": ("offline_inference_vision_language.py", ["--max-tokens 256", "-tp 1", "--disable-mm-preprocessor-cache"], None, ["VLLM_ASSETS_CACHE=../vllm/"]),
    ...
    "pixtral": ("offline_inference_vision_language.py", ["--max-tokens 256", "-tp 1", "--tokenizer-mode 'mistral'"], None, ["VLLM_ASSETS_CACHE=../vllm/"]),
    ...
    "llava_next_video_7b": ("offline_inference_vision_language.py", ["--max-tokens 256", "-tp 1", "--model-type llava-next-video", "--modality video", "--dtype bfloat16"], None, ["VLLM_ASSETS_CACHE=../vllm/"]),
    ...
    "qwen2_vl": ("offline_inference_vision_language.py", ["--max-tokens 256", "-tp 1", "--max-num-seqs 5"], None, ["VLLM_ASSETS_CACHE=../vllm/", "ENABLE_FLASH_ATTENTION_WITH_HEAD_DIM_PADDING=1"]),
    "qwen2_5_vl": ("offline_inference_vision_language.py", ["-tp 1", "--max-token 256"], None, ["VLLM_ASSETS_CACHE=../vllm/", "ENABLE_FLASH_ATTENTION_WITH_HEAD_DIM_PADDING=1"]),
    "e5-v": ("offline_inference_vision_language_embedding.py", ["--model-name e5_v"], None, []),
    "glm-4v": ("offline_inference_vision_language.py", ["--max-tokens 256", "-tp 1", "--hf-overrides '{\"architectures\": [\"GLM4VForCausalLM\"]}'"], None, ["VLLM_ASSETS_CACHE=../vllm/"]),
