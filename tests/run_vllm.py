...
_VISION_MODEL_CONFIGS = {
    "aria": ("offline_inference_vision_language.py", ["--max-model-len 4096", "--max-num-seqs 2", "-tp 2", "--dtype bfloat16", "--disable-mm-preprocessor-cache"], "0,1", ["VLLM_ASSETS_CACHE=../vllm/"]),
    "chameleon_7b": ("offline_inference_vision_language.py", ["--max-tokens 256", "-tp 1", "--max-model-len 8192"], None, ["VLLM_ASSETS_CACHE=../vllm/"]),
    "fuyu_8b": ("offline_inference_vision_language.py", ["--max-tokens 256", "-tp 1", "--max-model-len 8192"], None, ["VLLM_ASSETS_CACHE=../vllm/"]),
    "idefics3": ("offline_inference_vision_language.py", ["--model-type idefics3"], None, []),
    "h2vol": ("offline_inference_vision_language.py", ["--max-tokens 256", "-tp 1", "--max-model-len 8192", "--disable-mm-preprocessor-cache"], None, ["VLLM_ASSETS_CACHE=../vllm/"]),
    ...
    "llama-3.2": ("offline_inference_vision_language.py", ["--max-tokens 256", "-tp 1", "--max-model-len 8192", "--max-num-seqs 2"], None, ["VLLM_ASSETS_CACHE=../vllm/", "VLLM_FORCE_NCCL_COMM=1"]),
    "pixtral": ("offline_inference_vision_language.py", ["--max-tokens 256", "-tp 1", "--max-model-len 8192", "--tokenizer-mode 'mistral'"], None, ["VLLM_ASSETS_CACHE=../vllm/"]),
    "llava": ("offline_inference_vision_language.py", ["--max-tokens 256", "-tp 1", "--model-type llava-next", "--max-model-len 4096"], None, ["VLLM_ASSETS_CACHE=../vllm/"]),
    "llava_next_video_7b": ("offline_inference_vision_language.py", ["--max-tokens 256", "-tp 1", "--model-type llava-next-video", "--modality video", "--dtype bfloat16", "--max-model-len 8192"], None, ["VLLM_ASSETS_CACHE=../vllm/"]),
    "intern_vl": ("offline_inference_vision_language.py", ["--max-tokens 256", "-tp 1", "--max-model-len 2048"], None, ["VLLM_ASSETS_CACHE=../vllm/"]),
    "qwen_vl": ("offline_inference_vision_language.py", ["--model-type qwen_vl"], None, ["VLLM_ASSETS_CACHE=../vllm/"]),
    "qwen2_vl": ("offline_inference_vision_language.py", ["--max-tokens 256", "-tp 1", "--max-model-len 8192", "--max-num-seqs 5"], None, ["VLLM_ASSETS_CACHE=../vllm/", "ENABLE_FLASH_ATTENTION_WITH_HEAD_DIM_PADDING=1"]),
    "qwen2_5_vl": ("offline_inference_vision_language.py", ["-tp 1", "--max-token 256", "--max-model-len 8192"], None, ["VLLM_ASSETS_CACHE=../vllm/", "ENABLE_FLASH_ATTENTION_WITH_HEAD_DIM_PADDING=1"]),
    "e5-v": ("offline_inference_vision_language_embedding.py", ["--model-name e5_v"], None, []),
    "glm-4v": ("offline_inference_vision_language.py", ["--max-tokens 256", "-tp 1", "--max-model-len 8192", "--hf-overrides '{\"architectures\": [\"GLM4VForCausalLM\"]}'"], None, ["VLLM_ASSETS_CACHE=../vllm/"]),
    "minicpm-o-2": ("offline_inference_vision_language.py", ["--max-model-len 4096", "--max-num-seqs 2", "--disable-mm-preprocessor-cache"], None, []),
    "phi3_v": ("offline_inference_vision_language.py", ["--max-tokens 256", "-tp 1", "--max-model-len 4096"], None, ["VLLM_ASSETS_CACHE=../vllm/"]),
