...
def main():
    ...
    if args.perf_only:
        ...
        # get dataloader
        dataloader = torch.utils.data.DataLoader(dataset, batch_size, num_workers=args.num_workers, drop_last=False)
        ...
        for data in tqdm(dataloader):
            ...
            module.set_input(args.input_name, tvm.nd.array(input_data, device))
            ...
            reid_evaluator.process(data, outputs)
