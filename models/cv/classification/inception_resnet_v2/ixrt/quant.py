...
from ppq.api import *
import os
from calibration_dataset import getdataloader, TransformImage
import argparse
import random
import numpy as np
import torch
...
def parse_args():
    ...
    parser.add_argument("--imgsz", type=int, default=300)
...
NETWORK_INPUTSHAPE = [64, 3, 300, 300]  # input shape of your network
...
dataloader = getdataloader(config.dataset_dir, val_tf, config.step, config.bsz, img_sz=config.imgsz)
