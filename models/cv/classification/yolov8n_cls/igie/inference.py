...
def get_dataloader(data_path, batch_size, num_workers, imgsz):
    # Ultralytics YOLO-cls val: Resize(imgsz) + ToTensor (/255) + Normalize(0, 1)
...
def main():
    ...
    if args.perf_only:
        ...
        dataloader = get_dataloader(args.datasets, batch_size, args.num_workers, args.imgsz)
        ...
        for image, label in tqdm(dataloader):
            ...
            total_num += origin_size if pad_batch else batch_size
