...
Pretrained model: <https://download.pytorch.org/models/regnet_y_800mf-58fc7688.pth>
...
```bash
python3 ../../igie_common/export.py --model-name regnet_y_800mf --weight regnet_y_800mf-58fc7688.pth --output regnet_y_800mf.onnx
```
...
```bash
# Accuracy
bash scripts/infer_regnet_y_800mf_fp16_accuracy.sh
# Performance
bash scripts/infer_regnet_y_800mf_fp16_performance.sh
```
