...
def main():
    ...
    quantize_static(args.model_path,
                ...
                nodes_to_exclude= [
                    '/model.105/Add', '/model.105/Add_1', '/model.105/Add_2', '/model.105/Concat_1', 
                    '/model.105/Concat_2', '/model.105/Concat_4', '/model.105/Concat_5', '/model.105/Concat_7', 
                    '/model.105/Concat_8', '/model.105/Concat_9', '/model.105/Mul', '/model.105/Mul_1', 
                    '/model.105/Mul_2', '/model.105/Mul_3', '/model.105/Mul_4', '/model.105/Mul_5'
                ],
