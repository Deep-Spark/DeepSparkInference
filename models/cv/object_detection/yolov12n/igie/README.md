...
python3 make_ir9_model.py -i yolov12n.onnx -o yolov12n_ir9.onnx
cp yolov12n_ir9.onnx yolov12n.onnx
```
...
```bash
# Accuracy
bash scripts/infer_yolov12n_int8_accuracy.sh
# Performance
bash scripts/infer_yolov12n_int8_performance.sh
```
...
| ------- | --------- | --------- | ------- | ------- | ------------ |
| YOLOv12n | 32        | FP16      | 379.749 | 0.559   | 0.403        |
| YOLOv12n | 32        | INT8      | 491.415 | 0.528   | 0.371        |
