...
```bash
# Accuracy
bash scripts/infer_yolov9s_fp16_accuracy.sh
# Performance
bash scripts/infer_yolov9s_fp16_performance.sh
```
...
```bash
# Accuracy
bash scripts/infer_yolov9_int8_accuracy.sh
# Performance
bash scripts/infer_yolov9_int8_performance.sh
```
...
| ------ | --------- | --------- | ------ | ------- | ------------ |
| YOLOv9s | 32        | FP16      | 548.715 | 0.625   | 0.464        |
| YOLOv9s | 32        | INT8      | 765.954 | 0.613   | 0.447        |
