...
Pretrained model: <https://github.com/THU-MIG/yolov10/releases/download/v1.1/yolov10x.pt>
...
```bash
# Accuracy
bash scripts/infer_yolov10x_fp16_accuracy.sh
# Performance
bash scripts/infer_yolov10x_fp16_performance.sh
```
...
| ------- | --------- | --------- | ------ | ------- | ------------ |
| YOLOv10x | 32        | FP16      | 180.876 | 0.710   | 0.540       |
