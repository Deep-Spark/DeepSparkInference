...
class PillarFeatureNet(nn.Module):
    ...
    def decorate_features(self, features, num_voxels, coors):
        """Feature decoration + padding mask (no learnable weights)."""
    ...
    def forward(self, features, num_voxels, coors):
        if not self.export_onnx:
            features = self.decorate_features(features, num_voxels, coors)
