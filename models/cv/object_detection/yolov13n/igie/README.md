...
```bash
# Accuracy
bash scripts/infer_yolov13n_fp16_accuracy.sh
# Performance
bash scripts/infer_yolov13n_fp16_performance.sh
```
...
```bash
# Accuracy
bash scripts/infer_yolov13n_int8_accuracy.sh
# Performance
bash scripts/infer_yolov13n_int8_performance.sh
```
...
| ------- | --------- | --------- | ------- | ------- | ------------ |
| YOLOv13n | 32        | FP16      | 282.096  | 0.574   | 0.412        |
| YOLOv13n | 32        | INT8      | 348.120  | 0.537   | 0.378        |
