...
Pretrained model: <https://github.com/ultralytics/assets/releases/download/v8.4.0/yolov8l.pt>
...
```bash
# Accuracy
bash scripts/infer_yolov8l_fp16_accuracy.sh
# Performance
bash scripts/infer_yolov8l_fp16_performance.sh
```
