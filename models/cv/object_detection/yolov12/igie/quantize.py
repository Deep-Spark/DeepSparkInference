...
def main():
    ...
    quantize_static(args.model_path,
                ...
                nodes_to_exclude=[
                    ...
                    '/model.21/cv3.0/cv3.0.0/cv3.0.0.0/conv/Conv',
                    '/model.21/cv3.0/cv3.0.1/cv3.0.1.0/conv/Conv',
                    '/model.21/cv3.1/cv3.1.0/cv3.1.0.0/conv/Conv',
                    '/model.21/cv3.1/cv3.1.1/cv3.1.1.0/conv/Conv',
                    '/model.21/cv3.2/cv3.2.0/cv3.2.0.0/conv/Conv',
                    '/model.21/cv3.2/cv3.2.1/cv3.2.1.0/conv/Conv',
                    '/model.21/Add_10', '/model.21/Add_11', '/model.21/Add_9', 
                    '/model.21/Concat_24', '/model.21/Concat_25', '/model.21/Mul_4', 
                    '/model.21/Mul_5', '/model.21/dfl/Softmax'
                ],
