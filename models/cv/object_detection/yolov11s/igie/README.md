...
Pretrained model: <https://github.com/ultralytics/assets/releases/download/v8.3.0/yolo11s.pt>
...
```bash
# Accuracy
bash scripts/infer_yolov11s_fp16_accuracy.sh
# Performance
bash scripts/infer_yolov11s_fp16_performance.sh
```
...
```bash
# Accuracy
bash scripts/infer_yolov11s_int8_accuracy.sh
# Performance
bash scripts/infer_yolov11s_int8_performance.sh
```
...
| -------- | --------- | --------- | -------- | ------- | ------------ |
| YOLOv11s | 32        | FP16      | 1006.34  | 0.635   | 0.465        |
| YOLOv11s | 32        | INT8      | 1354.66  | 0.620   | 0.442        |
