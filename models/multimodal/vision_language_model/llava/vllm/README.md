...
python3 offline_inference_vision_language.py --model /path/to/model --max-tokens 256 -tp 1 --trust-remote-code --temperature 0.0 --model-type llava-next --max-model-len 4096
```
