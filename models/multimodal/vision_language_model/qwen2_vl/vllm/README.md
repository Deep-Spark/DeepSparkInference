...
python3 offline_inference_vision_language.py --model /path/to/Qwen2-VL-7B-Instruct --max-tokens 256 -tp 1 --trust-remote-code --temperature 0.0 --max-model-len 8192 --max-num-seqs 5
```
...
| :----: | :----: | :----: | :----: | :----: |
| Qwen2-VL | BF16 | 0.52 | 444.1 | 66.49 |