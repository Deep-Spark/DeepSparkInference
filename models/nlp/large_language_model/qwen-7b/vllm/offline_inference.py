...
if args.remove_chat_template:
    ...
    try:
        ...
        prompts_new = [build_chat(llm.get_tokenizer(),prompt,model_name,max_length=args.max_generate_tokens)[1] for prompt in prompts]
...
# 0.3.2 14b tokens: 474, QPS: 59.27844278977379
