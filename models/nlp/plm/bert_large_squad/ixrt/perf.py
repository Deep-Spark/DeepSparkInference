    ...
    with open(args.engine, 'rb') as f:
        ...
        for batch_size in sorted(args.batch_size):
            ...
            for idx in range(engine.num_optimization_profiles):
                profile_shape = engine.get_profile_shape(idx, idx * num_binding_per_profile)
            ...
            shapes = {
                0 : (batch_size, args.sequence_length),
                1 : (batch_size, args.sequence_length),
                2 : (batch_size, args.sequence_length),
            }

            for binding, shape in shapes.items():
                context.set_binding_shape(binding, shape)
