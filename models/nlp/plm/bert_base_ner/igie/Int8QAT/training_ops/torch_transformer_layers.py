...
from torch.nn import Dropout, LayerNorm, Parameter
...
class MultiheadAttention(nn.Module):
    ...
    def __init__(
        ...
        self.atten_score_out_quant = TensorQuantizer(
            QuantDescriptor(num_bits=8, narrow_range=True, learn_amax=False, amax=1.0)
        )
